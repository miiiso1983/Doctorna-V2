...
<head>
    ...
    <meta name="description" content="لوحة المريض - نظام Doctorna">
    
    <!-- CSRF Token -->
    <?= CSRF::meta() ?>
    
    <title><?= $title ?? 'لوحة المريض' ?> - <?= APP_NAME ?></title>
    ...
    <style>
        ...
        .stat-card {
            background: linear-gradient(135deg, var(--bg-color, #17a2b8) 0%, var(--bg-color-end, #6f42c1) 100%);
            color: white;
        }
        ...
        .appointment-card {
            border-left: 4px solid var(--status-color, #17a2b8);
            transition: all 0.3s ease;
        }
        ...
        <div class="p-3">
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="sidebar-text">
                    ...
                    <small class="text-white-50">لوحة المريض</small>
                </div>
            </div>
        </div>
    ...
    <div class="main-content" id="main-content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <h4 class="mb-0"><?= $title ?? 'لوحة المريض' ?></h4>
                    ...
                    <div class="nav-item dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="#">
                                <i class="fas fa-check-circle me-2 text-success"></i>تم قبول موعدك مع د. أحمد
                            </a></li>
                            <li><a class="dropdown-item" href="#">
                                <i class="fas fa-clock me-2 text-warning"></i>تذكير: موعد غداً الساعة 10:00
                            </a></li>
                           ...
                           role="button" data-bs-toggle="dropdown">
                            <?php if (!empty($this->user()['avatar'])): ?>
                                <img src="<?= $this->asset('uploads/profiles/' . $this->user()['avatar']) ?>" 
                                     alt="الصورة الشخصية" class="patient-avatar me-2">
                            <?php else: ?>
